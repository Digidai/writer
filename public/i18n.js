...
export const MESSAGES = {
  zh: {
    ...
    'editor.finishHintTouch': '完成并归档',
    'editor.hint': 'Tab 采纳建议 · ⌘⏎ 完成归档 · 静置片刻自动归档',
    'editor.hintMobile': '完成可归档 · 静置片刻自动归档',
    'editor.hintMobileGhost': '点“采纳”应用建议 · 完成可归档 · 静置片刻自动归档',
    'editor.ready': '就绪',
    'editor.saving': '保存中…',
    ...
    'editor.acceptSuggestion': '采纳',
    'editor.dismissSuggestion': '忽略',
    ...
    'archive.modeKeyword': '关键词',
    'archive.modeSemantic': '语义',
    'archive.semanticFallback': '语义检索暂不可用，已切换为关键词检索',
    'archive.exportZip': '导出 .zip',
    'archive.exportUnavailable': '公开演示站不提供整库导出',
    'archive.exportTooLarge': '档案太大，暂无法一次导出',
    'archive.exportFailed': '导出失败，稍后重试',
  ...
  en: {
    ...
    'editor.finishHintTouch': 'Finish and archive',
    'editor.hint': 'Tab accepts · ⌘⏎ archives · idle pieces file themselves',
    'editor.hintMobile': 'Finish archives · idle pieces file themselves',
    'editor.hintMobileGhost': 'Tap Accept for suggestions · Finish archives · idle pieces file themselves',
    'editor.ready': 'Ready',
    ...
    'editor.dismissSuggestion': 'Dismiss',
    ...
    'archive.modeKeyword': 'Keyword',
    'archive.modeSemantic': 'Semantic',
    'archive.semanticFallback': 'Semantic search is unavailable, switched to keyword search.',
    'archive.exportZip': 'Export .zip',
    'archive.exportUnavailable': 'Bulk export is disabled on the public demo.',
    'archive.exportTooLarge': 'Archive is too large to export at once.',
    'archive.exportFailed': 'Export failed, try again shortly.',
    ...
    'settings.languageDesc': 'Auto follows the browser, or lock Chinese / English',
    ...
    'settings.completionDesc': 'A grey continuation appears when you pause',
    'settings.completionDelay': 'Suggestion timing',
    'settings.completionDelayDesc': 'How long a pause lasts before a suggestion',
    'settings.agentFormatting': 'Agent typesetting',
    'settings.agentFormattingDesc': 'Typeset paragraphs and lists when filing',
